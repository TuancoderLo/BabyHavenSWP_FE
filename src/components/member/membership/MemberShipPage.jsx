                ...
                <div className="step2-container">
                  ...
                  <div className="subscription-box">
                    ...
                    <div className="subscription-dates">
                      ...
                      <div>
                        End date:{" "}
                        {new Date(new Date().setMonth(new Date().getMonth() + selectedPackage?.durationMonths)).toLocaleDateString()}
                      </div>
                    </div>
            ...
            {currentStep === 3 && selectedPackage && (
              <div className="transaction-step final-step">
                ...
                <p className="final-msg">
                  Your <strong>{selectedPackage.packageName}</strong> features are now available.
                </p>
