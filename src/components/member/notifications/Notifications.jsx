...
const sampleNotifications = [
  ...
  { id: 3, type: 'appointment', message: 'Appointment reminder: Doctor visit scheduled on Mar 10, 2025.', timestamp: new Date('2025-03-03T09:15:00'), read: false },
        ...
        {filteredNotifications.map(n => (
          <li key={n.id} className={`notification-item ${n.read ? 'read' : 'unread'}`}>
            ...
            <div className="notification-content">
              ...
              <span className="notification-timestamp">{n.timestamp.toLocaleString()}</span>
            </div>
            {!n.read && (
